		...
		public function npt_taxonomy_register_fields() {
			...
			return $args = array(
				'slug'          => array(
					...
					'field'             => 'arguments',
					'group'             => 'register',
					'value'             => isset( $taxonomy['slug'] ) ? $taxonomy['slug'] : '',
					'key'               => 'slug',
					'name'              => 'slug',
					'id'                => 'slug',
				...
				'singular_name' => array(
					...
					'value'             => isset( $taxonomy['labels']['singular_name'] ) ? $taxonomy['labels']['singular_name'] : '',
					'required'          => true,
					'wrap'              => true,
				),
				'name'          => array(
					...
					'value'             => isset( $taxonomy['labels']['name'] ) ? $taxonomy['labels']['name'] : '',
					'required'          => true,
					'wrap'              => true,
				),
				'description'   => array(
					...
					'value'             => isset( $taxonomy['description'] ) ? $taxonomy['description'] : '',
					'required'          => false,
					'wrap'              => true,
				),
				'post_types'    => array(
					...
					'name'              => 'post_types',
					'id'                => 'post_types',
					'label_description' => 'Add support for available registered post types. At least one is required. </br> By default only public post types are listed.',
					'wrap'              => true,
		...
		public function npt_taxonomy_labels_fields() {
			...
			return $args = array(
				...
				'menu_name'                  => array(
					...
					'value'             => isset( $taxonomy['labels']['menu_name'] ) ? $taxonomy['labels']['menu_name'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'all_items'                  => array(
					...
					'value'             => isset( $taxonomy['labels']['all_items'] ) ? $taxonomy['labels']['all_items'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'edit_item'                  => array(
					...
					'value'             => isset( $taxonomy['labels']['edit_item'] ) ? $taxonomy['labels']['edit_item'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'view_item'                  => array(
					...
					'value'             => isset( $taxonomy['labels']['view_item'] ) ? $taxonomy['labels']['view_item'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'update_item'                => array(
					...
					'value'             => isset( $taxonomy['labels']['update_item'] ) ? $taxonomy['labels']['update_item'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'add_new_item'               => array(
					...
					'value'             => isset( $taxonomy['labels']['add_new_item'] ) ? $taxonomy['labels']['add_new_item'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'new_item_name'              => array(
					...
					'value'             => isset( $taxonomy['labels']['new_item_name'] ) ? $taxonomy['labels']['new_item_name'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'parent_item'                => array(
					...
					'value'             => isset( $taxonomy['labels']['parent_item'] ) ? $taxonomy['labels']['parent_item'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'parent_item_colon'          => array(
					...
					'placeholder'       => '(e.g. Parent Genre:)',
					'label_description' => 'The same as <b>Parent Item</b>, but with colon : in the end.',
					'value'             => isset( $taxonomy['labels']['parent_item_colon'] ) ? $taxonomy['labels']['parent_item_colon'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
						'label' => sprintf( esc_attr__( 'Parent %s:', 'npt' ), 'item' ),
				...
				'search_items'               => array(
					...
					'value'             => isset( $taxonomy['labels']['search_items'] ) ? $taxonomy['labels']['search_items'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'popular_items'              => array(
					...
					'value'             => isset( $taxonomy['labels']['popular_items'] ) ? $taxonomy['labels']['popular_items'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'separate_items_with_commas' => array(
					...
					'value'             => isset( $taxonomy['labels']['separate_items_with_commas'] ) ? $taxonomy['labels']['separate_items_with_commas'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'add_or_remove_items'        => array(
					...
					'value'             => isset( $taxonomy['labels']['add_or_remove_items'] ) ? $taxonomy['labels']['add_or_remove_items'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'choose_from_most_used'      => array(
					...
					'label_description' => esc_html__( 'Label used in the meta box.', 'npt' ),
					'value'             => isset( $taxonomy['labels']['choose_from_most_used'] ) ? $taxonomy['labels']['choose_from_most_used'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'not_found'                  => array(
					...
					'value'             => isset( $taxonomy['labels']['not_found'] ) ? $taxonomy['labels']['not_found'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'no_terms'                   => array(
					...
					'value'             => isset( $taxonomy['labels']['no_terms'] ) ? $taxonomy['labels']['no_terms'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'filter_by_item'             => array(
					...
					'value'             => isset( $taxonomy['labels']['filter_by_item'] ) ? $taxonomy['labels']['filter_by_item'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'items_list_navigation'      => array(
					...
					'value'             => isset( $taxonomy['labels']['items_list_navigation'] ) ? $taxonomy['labels']['items_list_navigation'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'items_list'                 => array(
					...
					'value'             => isset( $taxonomy['labels']['items_list'] ) ? $taxonomy['labels']['items_list'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'most_used'                  => array(
					...
					'value'             => isset( $taxonomy['labels']['most_used'] ) ? $taxonomy['labels']['most_used'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'back_to_items'              => array(
					...
					'value'             => isset( $taxonomy['labels']['back_to_items'] ) ? $taxonomy['labels']['back_to_items'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'item_link'                  => array(
					...
					'value'             => isset( $taxonomy['labels']['item_link'] ) ? $taxonomy['labels']['item_link'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'item_link_description'      => array(
					...
					'value'             => isset( $taxonomy['labels']['item_link_description'] ) ? $taxonomy['labels']['item_link_description'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'name_field_description'     => array(
					...
					'value'             => isset( $taxonomy['labels']['name_field_description'] ) ? $taxonomy['labels']['name_field_description'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'slug_field_description'     => array(
					...
					'value'             => isset( $taxonomy['labels']['slug_field_description'] ) ? $taxonomy['labels']['slug_field_description'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'parent_field_description'   => array(
					...
					'value'             => isset( $taxonomy['labels']['parent_field_description'] ) ? $taxonomy['labels']['parent_field_description'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
				...
				'desc_field_description'     => array(
					...
					'value'             => isset( $taxonomy['labels']['desc_field_description'] ) ? $taxonomy['labels']['desc_field_description'] : '',
					'required'          => false,
					'wrap'              => true,
					'data'              => array(
		...
		public function npt_taxonomy_arguments_fields() {
			...
			return $args = array(
				'public'                => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['public'] ) ? $taxonomy['public'] : false,
					'key'               => 'public',
					'name'              => 'public',
					'id'                => 'public',
				...
				'publicly_queryable'    => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['publicly_queryable'] ) ? $taxonomy['publicly_queryable'] : false,
				...
				'hierarchical'          => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['hierarchical'] ) ? $taxonomy['hierarchical'] : false,
					'key'               => 'hierarchical',
					'name'              => 'hierarchical',
					'id'                => 'hierarchical',
				...
				'show_ui'               => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['show_ui'] ) ? $taxonomy['show_ui'] : false,
					'key'               => 'show_ui',
					'name'              => 'show-ui',
					'id'                => 'show-ui',
				...
				'show_in_menu'          => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['show_in_menu'] ) ? $taxonomy['show_in_menu'] : false,
					'key'               => 'show_in_menu',
					'name'              => 'show-in-menu',
					'id'                => 'show-in-menu',
				...
				'show_in_nav_menus'     => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['show_in_nav_menus'] ) ? $taxonomy['show_in_nav_menus'] : false,
				...
				'show_in_rest'          => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['show_in_rest'] ) ? $taxonomy['show_in_rest'] : false,
					'key'               => 'show_in_rest',
					'name'              => 'show-in-rest',
					'id'                => 'show-in-rest',
				...
				'rest_base'             => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['rest_base'] ) ? $taxonomy['rest_base'] : '',
					'key'               => 'rest_base',
					'name'              => 'rest-base',
					'id'                => 'rest-base',
				...
				'rest_namespace'        => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['rest_namespace'] ) ? $taxonomy['rest_namespace'] : '',
					'key'               => 'rest_namespace',
					'name'              => 'rest-namespace',
					'id'                => 'rest-namespace',
				...
				'rest_controller_class' => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['rest_controller_class'] ) ? $taxonomy['rest_controller_class'] : '',
					'key'               => 'rest_controller_class',
					'name'              => 'rest-controller-class',
					'id'                => 'rest-controller-class',
					'placeholder'       => 'Default: WP_REST_Terms_Controller',
					'label_description' => 'Read more about <a target="_blank" href="https://developer.wordpress.org/reference/classes/wp_rest_terms_controller/">WP_REST_Terms_Controller</a>',
					'wrap'              => true,
				),
				'show_tagcloud'         => array(
				...
				'show_in_quick_edit'    => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['show_in_quick_edit'] ) ? $taxonomy['show_in_quick_edit'] : false,
				...
				'show_admin_column'     => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['show_admin_column'] ) ? $taxonomy['show_admin_column'] : false,
				...
				'meta_box_cb'           => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['meta_box_cb'] ) ? $taxonomy['meta_box_cb'] : '',
					'key'               => 'meta_box_cb',
					'name'              => 'meta-box-cb',
					'id'                => 'meta-box-cb',
				...
				'meta_box_sanitize_cb'  => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['meta_box_sanitize_cb'] ) ? $taxonomy['meta_box_sanitize_cb'] : '',
				...
				'rewrite_slug'          => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['rewrite_slug'] ) ? $taxonomy['rewrite_slug'] : '',
					'key'               => 'rewrite_slug',
					'name'              => 'rewrite-slug',
					'id'                => 'rewrite-slug',
				...
				'with_front'            => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['with_front'] ) ? $taxonomy['with_front'] : false,
					'key'               => 'with_front',
					'name'              => 'with-front',
					'id'                => 'with-front',
				...
				'rewrite_hierarchical'  => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['rewrite_hierarchical'] ) ? $taxonomy['rewrite_hierarchical'] : false,
				...
				'query_var'             => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['query_var'] ) ? $taxonomy['query_var'] : false,
					'key'               => 'query_var',
					'name'              => 'query-var',
					'id'                => 'query-var',
				...
				'query_var_slug'        => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['query_var_slug'] ) ? $taxonomy['query_var_slug'] : false,
					'key'               => 'query_var_slug',
					'name'              => 'query-var-slug',
					'id'                => 'query-var-slug',
					'placeholder'       => 'Default: Taxonomy Slug',
				...
				'default_term'          => array(
					...
					'field'             => 'arguments',
					'group'             => 'arguments',
					'value'             => isset( $taxonomy['default_term'] ) ? $taxonomy['default_term'] : '',
					'key'               => 'default_term',
					'name'              => 'default-term',
					'id'                => 'default-term',
					'placeholder'       => '(e.g. name, slug, description)',
					'label_description' => 'Default term to be used for the taxonomy. </br> You can set taxonomy name, slug and description, only name required slug and description are optional.',
					'wrap'              => true,
				),
			);
		}
